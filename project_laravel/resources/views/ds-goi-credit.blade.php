...
<h1>Danh sách gói credit</h1>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
               	<p><a href="{{ route('goi-credit.them-moi') }}" type="button"  class="btn btn-primary btn-rounded waves-effect waves-light">Thêm mới</a></p>
                <table id="linh-vuc-datatable" class="table dt-responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            	<a href="{{ route('goi-credit.cap-nhat', ['id' => $goiCredit->id]) }}" class="btn btn-success waves-effect waves-light"><i class="mdi mdi-pencil"></i></a>
