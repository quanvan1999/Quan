...
<html lang="en">
    <head>
        ...
        <link href="{{asset('assets/libs/sweetalert2/sweetalert2.min.css') }}" rel="stylesheet" type="text/css"></link>
@yield('css')
    </head>
...
@include('partials.navigation')
        ...
        <div class="right-bar">
            ...
            <div class="slimscroll-menu">
                ...
                <div class="user-box">
                    <div class="user-img">
                        <img src="{{asset('assets/images/').'/'.Auth::user()->anh_dai_dien }}" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">
