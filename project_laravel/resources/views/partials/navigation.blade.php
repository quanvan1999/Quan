            ...
            <ul class="list-unstyled topnav-menu float-right mb-0">
                ...
                <li class="dropdown notification-list">
                    <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        ...
                        <img src="{{asset('assets/images/admin/').'/'.Auth::user()->anh_dai_dien }}" alt="user-image" class="rounded-circle">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                        ...
                        <!-- item-->
                        <a href="{{ route('quan-tri-vien.view') }}" class="dropdown-item notify-item">
                            <i class="fe-user"></i>
                            <span>Tài khoản</span>
                        </a>
                ...
                <ul class="navigation-menu">
                    ...
                    <li class="">
                        <a href="{{ route('dashboard') }}">
                            <i class=""></i>Dashboards <div class="arrow-down"></div></a>                 
                    </li>
